...
{
#ifdef LODEPNG_COMPILE_DECODER
  mse::TRegisteredObj<LodePNGDecoderSettings > decoder; /*the decoding settings*/
#endif /*LODEPNG_COMPILE_DECODER*/
#ifdef LODEPNG_COMPILE_ENCODER
  mse::TRegisteredObj<LodePNGEncoderSettings > encoder; /*the encoding settings*/
#endif /*LODEPNG_COMPILE_ENCODER*/
...
unsigned decompress(mse::mstd::vector<unsigned char>&  out, mse::lh::TLHNullableAnyRandomAccessIterator<const unsigned char>  in, size_t insize,
                    const mse::TRegisteredObj<LodePNGDecompressSettings >&  settings = lodepng_default_decompress_settings);
...
unsigned compress(mse::mstd::vector<unsigned char>&  out, mse::lh::TLHNullableAnyRandomAccessIterator<const unsigned char>  in, size_t insize,
                  const mse::TRegisteredObj<LodePNGCompressSettings >&  settings = lodepng_default_compress_settings);

...
typedef struct LodePNGInfo
{
  ...
  mse::TNoradObj<LodePNGColorMode > color;     /*color type and bits, palette and transparency of the PNG file*/
  ...
  */
  ...
  mse::TNoradObj<LodePNGTime > time;
...
{
  mse::TNoradObj<LodePNGDecompressSettings > zlibsettings; /*in here is the setting to ignore Adler32 checksums*/
...
{
  mse::TNoradObj<LodePNGCompressSettings > zlibsettings; /*settings for the zlib encoder, such as window size, ...*/
...
{
#ifdef LODEPNG_COMPILE_DECODER
  mse::TNoradObj<LodePNGDecoderSettings > decoder; /*the decoding settings*/
#endif /*LODEPNG_COMPILE_DECODER*/
#ifdef LODEPNG_COMPILE_ENCODER
  mse::TNoradObj<LodePNGEncoderSettings > encoder; /*the encoding settings*/
#endif /*LODEPNG_COMPILE_ENCODER*/
  mse::TNoradObj<LodePNGColorMode > info_raw; /*specifies the format in which you would like to get the raw pixel buffer*/
  mse::TNoradObj<LodePNGInfo > info_png; /*info of the PNG image obtained after decoding*/
...
unsigned lodepng_crc32(mse::lh::TLHNullableAnyRandomAccessIterator<const unsigned char>  buf, size_t len);
...
class State : public LodePNGState
{
  public:
    State();
    State(const mse::TNoradObj<class lodepng::State >&  other);
    virtual ~State();
    State& operator=(const mse::TNoradObj<class lodepng::State >&  other);
};
...
unsigned decompress(mse::mstd::vector<unsigned char>&  out, mse::lh::TLHNullableAnyRandomAccessIterator<const unsigned char>  in, size_t insize,
                    const mse::TNoradObj<LodePNGDecompressSettings >&  settings = lodepng_default_decompress_settings);
...
unsigned compress(mse::mstd::vector<unsigned char>&  out, mse::lh::TLHNullableAnyRandomAccessIterator<const unsigned char>  in, size_t insize,
                  const mse::TNoradObj<LodePNGCompressSettings >&  settings = lodepng_default_compress_settings);

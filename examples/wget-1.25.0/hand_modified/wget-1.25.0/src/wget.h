...
#ifdef __cplusplus
#define BASEVAR_NEW_CAST_TYPE_FOR_POINTER_ARITHMETIC(x) decltype(x)
#define BASEVAR_NEW_TARGET_SIZE_FOR_POINTER_ARITHMETIC(x) sizeof(*x)
#else /* __cplusplus */
#define BASEVAR_NEW_CAST_TYPE_FOR_POINTER_ARITHMETIC(x) char*
#define BASEVAR_NEW_TARGET_SIZE_FOR_POINTER_ARITHMETIC(x) sizeof(char)
#endif /* __cplusplus */
